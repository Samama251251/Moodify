        ...
        <div className="w-full max-w-[448px] sm:bg-white sm:rounded-[32px] sm:shadow-[0px_20px_20px_rgba(125,87,0,0.06)] sm:p-8 lg:p-10">
          ...
          <form action={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-[56px] mt-1 rounded-full bg-gradient-to-r from-[#7d5700] to-[#e5a623] text-white text-[17px] font-semibold shadow-[0px_10px_20px_rgba(125,87,0,0.15)] hover:shadow-[0px_14px_28px_rgba(125,87,0,0.2)] active:scale-[0.98] transition-all duration-150 disabled:opacity-60 flex items-center justify-center gap-2"
            >
              {loading ? (
